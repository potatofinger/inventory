...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="status" id="'.$row["brand_id"].'" class="btn btn-primary btn-xs status" data-status="'.$row["brand_status"].'">Change status</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["brand_id"].'" class="btn btn-danger btn-xs delete" data-status="'.$row["brand_name"].'">Delete</button>';
	$data[] = $sub_array;
}
