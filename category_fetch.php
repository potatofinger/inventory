...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="status" id="'.$row["category_id"].'" class="btn btn-primary btn-xs status" data-status="'.$row["category_status"].'">Change status</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["category_id"].'" class="btn btn-danger btn-xs delete" data-status="'.$row["category_name"].'">Delete</button>';
