...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Dec 20, 2024 at 02:33 AM
...
(6, 6, 'Aliquam', 'active'),
(7, 6, 'Maximus', 'active'),
(8, 10, 'Samsung LED', 'active'),
(9, 10, 'Toshiba', 'active'),
(10, 3, 'Vitae', 'active'),
(11, 3, 'Auctor', 'active'),
(12, 5, 'Panasonic', 'active'),
(13, 5, 'Sylvania', 'active'),
(14, 2, 'Osram', 'active'),
(15, 2, 'GE Lighting', 'active'),
...
(2, 1, 3, '17W B22 LED Bulb', 'Item Height	14.2 (cm)\r\nColor Temperature (Kelvin)	6500\r\nItem Weight	0.19 (kg)\r\nBulb Material	Aluminium\r\nBase Color	Aluminium\r\nVoltage	240\r\nUsages	Household, Commercial, Kitchen', 80, 'Box', 350.00, 12.00, 0.00, 1, 'active', '2017-11-08'),
(3, 8, 5, '18W LED Ceiling Light', 'Round Ceiling Light 18w', 75, 'Box', 800.00, 5.00, 0.00, 1, 'active', '2017-11-08'),
...
(23, 1, 3, '15 Watt LED Bulb', '15 Watt LED Bulb', 125, 'Box', 30.00, 12.00, 0.00, 1, 'active', '2017-11-21');
...
(1, 'arvee@gmail.com', '$2y$10$8v7M/g6n9lxTrHombOSUWuUcevwu83tfNsgP1J4dQ2IcQk/5D66/q', 'Lance Arvee Algire', 'master', 'Active'),
(2, 'algire@gmail.com', '$2y$10$M4QNUnU6e1iWphGVTEjdO.8ro/8SaNJ.tg1oj.Or81mFjCJq9XPyy', 'algire', 'user', 'Active'),
(11, 'lance@gmail.com', '$2y$10$UYKmE/VV.aiqYQb.ZCRTA.zYOknXbUtfuTV9IVnsyoeFgoyyylCQ.', 'lance', 'user', 'Inactive');
